...
public class Tests {
	...
	@Test
	public void testf(){
		assertEquals("Value for "+87, 91, Methods.f(87));
		assertEquals("Value for " + 99, 91, Methods.f(99));
	}
	
	@Test
	public void testg(){
		assertEquals("Value for " + 0 + " ", 2, Methods.g(1,0));
		assertEquals("Value for " + 2 + " ", 4, Methods.g(1,2));
		assertEquals("Value for " + 2 + " ", 7, Methods.g(2,2));
	}
